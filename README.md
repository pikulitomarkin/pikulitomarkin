...
- 🔭 Atualmente trabalhando em: **Soluções Corporativas e Aplicações Web**
- 🌱 Aprendendo: **Python, React e Inteligência Artificial**
- 👯 Procurando colaborar em: **Projetos Open Source e React**
- 💬 Me pergunte sobre: **IA, Desenvolvimento Web e Automação**
- ⚡ Curiosidade: **"Código limpo é poesia em movimento"**

---

## 💼 Projetos em Destaque

### 🌟 [Corte e Poda](https://github.com/pikulitomarkin/corte-poda)
...
### 🎯 [Onde a Linha Desligou - Web Debug](https://github.com/pikulitomarkin/onde_a_linha_desligou_web_debug)
> Aplicação web para consulta e visualização de torres de transmissão elétrica com localização por quilometragem e mapa interativo.

**🛠️ Stack:** Python • Flask • Railway • JavaScript

**✨ Destaques:**
- 🗺️ Consulta inteligente de torres por KM
- 📍 Visualização detalhada com mapas interativos
...
> App mobile para registro e acompanhamento de defeitos industriais com funcionalidades offline e sincronização automática.

**🛠️ Stack:** React Native • SQLite • Firebase • Expo

**✨ Destaques:**
- 📱 Aplicativo nativo multiplataforma
...
[![Portfolio](https://img.shields.io/badge/Portfolio-255E63?style=for-the-badge&logo=About.me&logoColor=white)](https://github.com/pikulitomarkin)
